...
<head>
    ...
    <title>Login - Klinik dr.yanti</title>
    <!-- Favicon-->
    ...
    <style type="text/css">
    body{
        background: url('<?= base_url();?>images/bg-login.jpeg') no-repeat scroll;
...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
        <br><br>
            <a href="javascript:void(0);"><h2>Klinik Pratama dr.Yanti</h2></a>
            <small>Klinik Keluarga</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" action="<?php echo base_url().'index.php/login/auth'?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col-xs-12 align-right">
                            <button class="btn btn-block bg-purple waves-effect" type="submit">
                             LOGIN</button>
                        </div>
                    </div>
                </form>
